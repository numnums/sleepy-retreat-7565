class StudentsController < ApplicationController
  ...
  def update
    ...
    if @student.update(params[:student].permit(:firstname, :lastname, :gender, :school_id, :parent_id, :wearsglasses, :birthdate, :classroomdescription, :classroomtime, :classroomdaymonday, :classroomdaytuesday, :classroomdaywednesday, :classroomdaythursday, :classroomdayfriday ))
  ...
  private
	def student_params
			params.require(:student).permit(:firstname, :lastname, :gender, :school_id, :parent_id, :wearsglasses, :birthdate, :classroomdescription, :classroomtime, :classroomdaymonday, :classroomdaytuesday, :classroomdaywednesday, :classroomdaythursday, :classroomdayfriday )
	end
